...
class test_post(TestCase):
    ...
    def test_partial_update_entities(self):
        ...
        c.setopt(pycurl.POSTFIELDS,fake_data.part_links)
...
class test_put(TestCase):
    ...
    def test_create_custom_resource(self):
        ...
        storage = StringIO.StringIO()
        c = pycurl.Curl()
        c.setopt(pycurl.URL,'http://127.0.0.1:8090/bilel/vms/v01')
        c.setopt(c.VERBOSE, False)
        c.setopt(pycurl.HTTPHEADER, ['Accept: application/occi+json','Content-Type: text/plain'])
