        ...
        if is_kind_loc is True:
            ...
            if db_occi_ids_locs is None or default_attributes is None:
                ...
                if jreq.has_key('links'):
                    ...
                    logger.debug("===== Channel_post_multi_resources ==== : Post on kind path to create a new link channeled")
                    new_links, resp_code_l = self.manager_l.register_links_explicit(jreq['links'],req_path,db_occi_ids_locs)
                else:
                    new_links = list()
            ...
            if nb_res is None:
                ...
                if db_docs is 0:
                    ...
                    logger.debug("===== Channel_post_multi_resources ==== : Post on mixin path to associate a mixin channeled")
